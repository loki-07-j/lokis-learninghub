    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 text-white px-4 relative overflow-hidden">
      ...
      <div className="relative text-center space-y-6 max-w-md w-full p-8 rounded-3xl border border-white/5 bg-slate-900/20 backdrop-blur-2xl shadow-2xl">
        ...
        <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center">
          <Link 
            href="/dashboard"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 hover:bg-white/5 hover:text-white text-slate-300 px-4 py-2.5 text-sm font-medium transition-all duration-200 cursor-pointer w-full sm:w-auto"
          >
          ...
          <button 
            onClick={() => router.back()} 
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white px-4 py-2.5 text-sm font-medium transition-all duration-200 cursor-pointer shadow-lg shadow-purple-500/25 border-none w-full sm:w-auto"
          >
